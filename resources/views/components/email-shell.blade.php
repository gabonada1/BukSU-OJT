...
<head>
    ...
    <title>{{ $title ?: config('app.name', 'BukSU Practicum Portal') }}</title>
</head>
                ...
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background:#ffffff;border:1px solid #e4d7dd;border-radius:20px;overflow:hidden;">
                    <tr>
                        <td style="padding:24px 28px;background:linear-gradient(135deg, #5E1423, #7B1C2E);color:#fff7ed;">
                            <p style="margin:0 0 10px;font-size:11px;letter-spacing:0.24em;text-transform:uppercase;opacity:0.9;">{{ $eyebrow ?: 'BukSU Practicum Portal' }}</p>
                    ...
                    <tr>
                        <td style="padding:28px;background:#ffffff;">
                            ...
                            <p style="margin:28px 0 0 0;font-size:13px;line-height:1.6;color:#6b7280;">BukSU Practicum Portal</p>
